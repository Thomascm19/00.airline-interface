...
public class Vuelos {
    ...
    public Vuelos(String Ciudad_destino, String Ciudad_origen,Date Fecha_regreso,Date Fecha_ida,int Numero_adultos,int Numero_niños,int Numero_bebes,String cc, int numero_sillasA, int numero_sillasB, int numero_sillasN,String Ida_vuelta) {
        this.cc = cc;
   ...
   public Vuelos() {
    ...
    /**
     * @param ida_vuelta the ida_vuelta to set
     */
